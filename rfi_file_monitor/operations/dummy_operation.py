...
class DummyOperation(Operation):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.add(self._grid)
        self._grid.attach(
            Gtk.Label(label="This is a dummy operation"), 0, 0, 1, 1
        )
        ...
        widget = self.register_widget(
            Gtk.CheckButton(
                active=False,
                label="Process as directories if supported",
                halign=Gtk.Align.FILL,
                valign=Gtk.Align.CENTER,
                hexpand=True,
                vexpand=False,
        ...
        widget = self.register_widget(
            Gtk.CheckButton(
                active=False,
                label="Add Operational Metadata",
                halign=Gtk.Align.FILL,
                valign=Gtk.Align.CENTER,
                hexpand=True,
                vexpand=False,
