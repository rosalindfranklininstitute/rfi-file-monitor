...
parser = argparse.ArgumentParser(description='Generate files into a directory for testing with the RFI-file-monitor')
parser.add_argument('destination', type=str, help='Directory to write files to')
parser.add_argument('--filesize', type=str, help='The filesize that the files will be generated with', default='1MB')
parser.add_argument('--sleeptime', type=int, help='The time between two files being written, in seconds', default=2)
...
parser.add_argument('--nsaves', type=int, help='Save file multiple times. Uses sleeptime for time between saves', default=1)
