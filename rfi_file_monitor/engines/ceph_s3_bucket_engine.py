...
class CephS3BucketEngine(BaseS3BucketEngine):
    ...
    def __init__(self, appwindow):
        ...
        self._ceph_endpoint_entry = self.register_widget(Gtk.Entry(
    ...
    def _s3_entry_changed_cb(self, entry):
        ...
        if self.params.ceph_endpoint.startswith('https://') and \
            self.params.bucket_name and \
...
class CephS3BucketEngineThread(BaseS3BucketEngineThread):
    ...
    def run(self):
        ...
        # set up sns client
        self._engine.sns_client = boto3.client('sns', **self._client_options, config=Config(signature_version='s3'))
        ...
        try:
            ...
            resp = self._engine.sns_client.create_topic(Name=topic_name, Attributes=attributes)
                    ...
                    while True:
                        ...
                        if method_frame:
                            ...
                            try:
                                ...
                                logger.debug(f'Ignoring {_body=} because of {str(e)}')
                                continue
